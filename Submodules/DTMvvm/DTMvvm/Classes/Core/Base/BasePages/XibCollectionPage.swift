//
//  XibCollectionPage.swift
//  DTMvvm
//
//  Created by apolo2 on 7/6/21.
//
...
open class XibCollectionPage<VM: IListViewModel>: Page<VM>, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    open func setupViewFromNib() {
        // Create view from xib file
        // And add it to self.view (required CollectionView in xib)
